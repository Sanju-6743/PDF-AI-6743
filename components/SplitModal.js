...
export default function SplitModal({ isOpen, onClose }) {
  ...
  const handleSplit = async () => {
    ...
    setProgress(0);
    setProgressText('Starting split process...');

    try {
      const splitPdfBytes = await splitPDF(files[0], pageNumbers, (progressValue, text) => {
      ...
      toast.success(`PDF split successfully! Extracted ${pageNumbers.length} page(s)`);
      onClose();
    } catch (error) {
        ...
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <input
              ...
              placeholder="e.g., 1,3,5-7 or 2,4,6"
